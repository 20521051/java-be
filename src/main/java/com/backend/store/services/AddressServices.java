...
class AddressService {
    ...
    public AddressDTO create(Address dto, String userId) {
        try {
    ...
    public AddressDTO update(String id, Address dto, String userId) {
    try {
    Address address = addressRepository.findById(id).orElseThrow(() -> new RuntimeException("Address not found"));

    if (address.isDefault() && !dto.isDefault()) {
        throw new RuntimeException("Cannot change default address");
    }
